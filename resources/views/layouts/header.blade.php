            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{URL::asset('assets/img/user.jpg')}}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('employee.index')}}" class="nav-item nav-link"><i class="fa fa-user me-2"></i>Employee</a>
        ...
        <div class="container-fluid pt-4 px-4" style="min-height:100vh;">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{URL::asset('assets/img/user.jpg')}}" alt="" style="width: 40px; height: 40px;">
